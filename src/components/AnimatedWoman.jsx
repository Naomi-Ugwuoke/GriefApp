...
Command: npx gltfjsx@6.2.15 public/models/AnimatedWoman.glb -o src/components/AnimatedWoman.jsx -r public 
*/
...
export function AnimatedWoman({
  ...
  // // check possible animations
  // console.log(actions);

  const [animation, setAnimation] = useState("CharacterArmature|Idle"); //default

  useEffect(() => {
    actions[animation].reset().fadeIn(0.5).play();
    return () => actions[amimation].fadeOut(0.5);
  }, [animation]);
